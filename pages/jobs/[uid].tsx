...
import { JobInProgressItemGroup } from "@/components/molecules";
...
import ClientReviewListItemGroup from "@/components/molecules/ClientReviewListItemGroup";
...
export default function JobPage() {
  const [jobsInProgressOpen, setJobsInProgressOpen] = useState(false);
  ...
  return (
    <>
      ...
      <SEO
        title="Easy Product Photo Task - $20 Payment"
        url={`/jobs/${uid}`}
        description="Easy Product Photo Task - $20 Payment"
      />
          ...
          <div className="w-3/4 border-r border-slate-300">
            <div className="p-8 border-b border-slate-300 space-y-8">
              <h1 className="text-xl font-medium">
                Easy Product Photo Task - $20 Payment
              </h1>
            ...
            <div className="p-8 border-b border-slate-300">
              <p className="text-sm">
                Summary
                <br />
                Overview We’re looking for a simple, straightforward photo of
                our product. No special skills or editing required—just take the
                photo and send it over. Compensation: $20 for a very quick task
                that takes approximately 1–2 minutes to complete. Eligibility:
                Open to all applicants. Everyone is welcome to apply!
              </p>
            </div>
            ...
            <div className="p-8 border-b border-slate-300 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <SkillsGroup skills={["Photography", "Product Photography"]} />
              </div>
            ...
            <div className="p-8 space-y-8">
              <div className="grid grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <p className="text-sm">
                    <strong className="font-medium">Location:</strong> France,
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="top">
                          <p className="text-sm p-2">
                            ...
                            archived. Please note that all proposals are
                            accessible to clients on their applicants page.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                      <span>5 to 10</span>
