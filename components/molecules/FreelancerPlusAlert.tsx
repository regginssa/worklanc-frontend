...
export default function FreelancerPlusAlert() {
  return (
    <>
      <Link
        href="#"
        className="freelancer-plus-alert p-4 flex items-start gap-10 rounded-lg shadow-lg text-white transition-all duration-300 border border-white hover:border-black hover:shadow-xl"
      >
