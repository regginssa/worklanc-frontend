...
export interface SearchableOptionItem {
  value: string;
  label: string;
}
              ...
              {filteredOptions.length > 0 && (
                ...
                >
                  {filteredOptions.map((option, index) => (
                    <motion.li
                      key={option.value}
                      className="flex items-center gap-2 p-2 hover:bg-slate-100 cursor-pointer transition-colors duration-200"
                      variants={{
