...
export default function HightlightListItem({
  ...
  return (
    <Reorder.Item
      ...
      className="p-6 bg-slate-50 rounded-xl flex items-center justify-between list-none"
    >
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <div className="relative w-[65px] h-[65px] rounded-lg border border-slate-300 bg-white overflow-hidden flex items-center justify-center">
            <Image
              src={image}
              alt={title}
              width={55}
